import{W as st,S as nt,P as it,b as ie,a as q,F as rt,V as j,M as pe,d as De,e as k,p as Oe,A as de,g as Ge,I as lt,q as ct,Q as ut,B as mt,m as ft,f as Re,r as ht,R as pt,s as d}from"./three.module-DRiFt6mT.js";function re(g){let e=g>>>0;return()=>{e|=0,e=e+1831565813|0;let y=Math.imul(e^e>>>15,1|e);return y=y+Math.imul(y^y>>>7,61|y)^y,((y^y>>>14)>>>0)/4294967296}}function t(g){return(g()+g()+g())/1.5-1}const dt=[5136383,3721471,3074264,3997550,11075374,14090030,16761134,16742972,16729431],We=`
...
`;function St(g){const e=re(20260810),y=[],b=[];{const c=new Float32Array(g*3);for(let h=0;h<g;h++)c[h*3]=t(e)*.42,c[h*3+1]=t(e)*.42,c[h*3+2]=t(e)*.42;y.push(c),b.push(new Float32Array(g))}{const c=new Float32Array(g*3),h=[];for(let p=0;p<26;p++)h.push([(e()*2-1)*2.4,(e()*2-1)*1.5,(e()*2-1)*.9]);for(let p=0;p<g;p++){const u=h[e()*h.length|0];c[p*3]=u[0]+t(e)*.16,c[p*3+1]=u[1]+t(e)*.16,c[p*3+2]=u[2]+t(e)*.16}y.push(c),b.push(new Float32Array(g))}{const c=new Float32Array(g*3),h=new Float32Array(g);for(let p=0;p<g;p++){const u=e();let i,l,r;if(u<.43){const a=t(e),s=t(e),m=t(e),n=Math.hypot(a,s,m)||1,f=1.05+(e()-.5)*.08;i=a/n*f,l=s/n*f,r=m/n*f}else if(u<.57){const a=t(e),s=t(e),m=t(e),n=Math.hypot(a,s,m)||1,f=.67+(e()-.5)*.045;i=a/n*f,l=s/n*f,r=m/n*f}else if(u<.68)i=t(e)*.42,l=t(e)*.42,r=t(e)*.24;else if(u<.81){const a=e()-.5;i=-.2+(e()<.5?-1:1)*a*.48+t(e)*.022,l=a*1.08+t(e)*.022,r=t(e)*.045,h[p]=-.82}else if(u<.91){if(e()<.54){const s=e();i=.23+(e()<.5?-1:1)*s*.22+t(e)*.02,l=.02+s*.43+t(e)*.02}else{const s=e();i=.23+t(e)*.022,l=.03-s*.5+t(e)*.02}r=t(e)*.045,h[p]=.82}else{const a=e()*Math.PI*2,s=.18+t(e)*.014;i=.57+Math.cos(a)*s,l=-.58+Math.sin(a)*s,r=t(e)*.035,h[p]=.58}c[p*3]=i,c[p*3+1]=l,c[p*3+2]=r}y.push(c),b.push(h)}{const c=new Float32Array(g*3),h=new Float32Array(g);for(let p=0;p<g;p++){const u=e();let i,l,r;if(u<.16)i=-1.5+t(e)*.3,l=t(e)*.22,r=t(e)*.13;else if(u<.23){const a=e()*Math.PI*2,s=2+(e()*3|0);i=-1.5+Math.cos(a*s)*.19+t(e)*.025,l=Math.sin(a*(s+1))*.12+t(e)*.02,r=Math.sin(a*2)*.055+t(e)*.018,h[p]=-.95}else if(u<.37){const a=e(),s=e()*Math.PI*2,m=.085+(e()-.5)*.02;i=-1.16+a*.61,l=Math.cos(s)*m,r=Math.sin(s)*m}else if(u<.95){const a=e();i=-.55+a*3.15;const s=.05*(1-a)+.008;l=.18*Math.sin((i+.55)*2.2)+t(e)*s,r=t(e)*s}else i=(e()-.5)*4.5,l=t(e)*.8,r=t(e)*.8;c[p*3]=i-.4,c[p*3+1]=l,c[p*3+2]=r}y.push(c),b.push(h)}{const c=new Float32Array(g*3),h=new Float32Array(g);for(let p=0;p<g;p++){const u=e();let i,l,r;if(u<.32){let a=t(e),s=t(e),m=t(e);const n=Math.hypot(a,s,m)||1,f=Math.cbrt(e())*1.16;i=a/n*f,l=s/n*f,r=m/n*f}else if(u<.5){let a=t(e),s=t(e),m=t(e);const n=Math.hypot(a,s,m)||1,f=1.32+(e()-.5)*.07;i=a/n*f,l=s/n*f,r=m/n*f}else if(u<.65){let a=t(e),s=t(e),m=t(e);const n=Math.hypot(a,s,m)||1,f=1.55+e()*.4;i=a/n*f+t(e)*.1,l=s/n*f+t(e)*.1,r=m/n*f+t(e)*.1}else if(u<.72){const a=e()*Math.PI*2,s=.22+.045*Math.sin(a*3);i=.3+Math.cos(a)*s+t(e)*.025,l=-.03+Math.sin(a)*s*.74+t(e)*.025,r=t(e)*.07,h[p]=.92}else if(u<.8)i=-1.48+t(e)*.18,l=.22+t(e)*.12,r=t(e)*.08;else if(u<.86){const a=e()*Math.PI*2;i=-.69+Math.cos(a*3)*.17+t(e)*.02,l=.18+Math.sin(a*4)*.12+t(e)*.02,r=Math.sin(a*2)*.05+t(e)*.018,h[p]=-.92}else{const a=e();i=-1.58-a*2.5;const s=.045*(1-a)+.008;l=.22+.3*Math.sin(a*5.2)*a+t(e)*s,r=t(e)*s}c[p*3]=i,c[p*3+1]=l,c[p*3+2]=r}y.push(c),b.push(h)}{const c=new Float32Array(g*3),h=(u,i,l,r,a)=>{const s=e();return[u+(l-u)*s+t(e)*a,i+(r-i)*s+t(e)*a,t(e)*a*1.6]},p=(u,i,l,r,a,s,m)=>{const n=e(),f=1-n;return[f*f*u+2*f*n*l+n*n*a+t(e)*m,f*f*i+2*f*n*r+n*n*s+t(e)*m,t(e)*m*1.6]};for(let u=0;u<g;u++){const i=e();let l,r,a;if(i<.13){const s=e()*Math.PI*2,m=.44+(e()-.5)*.05;l=-.18+Math.cos(s)*m,r=.62+Math.sin(s)*m*1.06,a=t(e)*.08}else if(i<.22)l=-.18+t(e)*.4,r=.62+t(e)*.42,a=t(e)*.3;else if(i<.25)[l,r,a]=h(-.6,.82,-.58,.36,.045),l-=Math.sin((r-.36)*3.2)*.07;else if(i<.4)[l,r,a]=p(.24,.94,.85,.12,.3,-.74,.08);else if(i<.52)l=.14+t(e)*.32,r=-.04+t(e)*.42,a=t(e)*.28;else if(i<.56)[l,r,a]=p(-.46,.28,-.5,-.2,-.02,-.52,.05);else if(i<.63)[l,r,a]=h(.26,-.56,-.26,-.4,.1);else if(i<.68)[l,r,a]=h(-.26,-.4,-.02,-.78,.075);else if(i<.71)l=.07+t(e)*.09,r=-.84+t(e)*.055,a=t(e)*.07;else if(i<.77)[l,r,a]=h(.1,.4,-.16,.1,.08);else if(i<.82)[l,r,a]=h(-.16,.1,-.48,.4,.065);else if(i<.85)l=-.53+t(e)*.075,r=.44+t(e)*.075,a=.04+t(e)*.06;else if(i<.96){let s=t(e),m=t(e),n=t(e);const f=Math.hypot(s,m,n)||1,w=1.5+(e()-.5)*.1;l=s/f*w*1.05,r=m/f*w*.95,a=n/f*w*.8}else l=t(e)*1.1,r=t(e)*1,a=t(e)*.7;c[u*3]=a*1.25,c[u*3+1]=r*1.25,c[u*3+2]=l*1.25}y.push(c),b.push(new Float32Array(g))}{const c=new Float32Array(g*3),h=new Float32Array(g),p=u=>.16*Math.sin(u*1.1);for(let u=0;u<g;u++){const i=e();let l,r,a;if(i<.28){let s=t(e),m=t(e),n=t(e);const f=Math.hypot(s,m,n)||1,w=.96+e()*.07;l=s/f*1.42*w,r=m/f*.6*w+p(l),a=n/f*.6*w}else if(i<.43){let s=t(e),m=t(e),n=t(e);const f=Math.hypot(s,m,n)||1;l=s/f*1.22,r=m/f*.5+p(l),a=n/f*.5}else if(i<.86){const m=-1.12+(e()*9|0)*.28,n=e()*Math.PI*2,f=Math.sqrt(e()),w=Math.cos(n)*f*.42,S=Math.sin(n)*f*.42;l=m+.09*Math.sin(w*9)+t(e)*.015,r=w+p(m),a=S}else if(i<.94){const s=e()*Math.PI*2;l=-.38+Math.cos(s)*.24+t(e)*.014,r=p(-.38)+Math.sin(s)*.17+t(e)*.014,a=t(e)*.025,h[u]=.88}else l=(e()-.5)*2.4,r=t(e)*.4+p(l),a=t(e)*.4;c[u*3]=a,c[u*3+1]=r,c[u*3+2]=l}y.push(c),b.push(h)}{const c=new Float32Array(g*3),h=new Float32Array(g),p=3,u=3.9,i=.62,l=30,r=2.1,a=19,s=[9,10],m=n=>(n/(l-1)-.5)*u;for(let n=0;n<g;n++){const f=e(),w=e(),S=(w-.5)*u,x=w*p*Math.PI*2;if(f<.33)c[n*3]=Math.cos(x)*i+t(e)*.016,c[n*3+1]=S,c[n*3+2]=Math.sin(x)*i+t(e)*.016,Math.abs(S-m(a))<.1&&(h[n]=-.58),Math.abs(S-m(s[0]))<.14&&(h[n]=.42);else if(f<.66)c[n*3]=Math.cos(x+r)*i+t(e)*.016,c[n*3+1]=S,c[n*3+2]=Math.sin(x+r)*i+t(e)*.016,Math.abs(S-m(a))<.1&&(h[n]=.58),Math.abs(S-m(s[1]))<.14&&(h[n]=.42);else{const C=e()*l|0,$=m(C),A=($/u+.5)*p*Math.PI*2,I=Math.floor(e()*44)/43,T=Math.cos(A)*i,J=Math.sin(A)*i,ee=Math.cos(A+r)*i,B=Math.sin(A+r)*i;c[n*3]=T+(ee-T)*I+t(e)*.006,c[n*3+1]=$+t(e)*.006,c[n*3+2]=J+(B-J)*I+t(e)*.006,C===a&&(h[n]=I<.5?-1:1),s.includes(C)&&(h[n]=.72)}}y.push(c),b.push(h)}{const c=new Float32Array(g*3),h=.55,p=Math.cos(h),u=Math.sin(h);for(let i=0;i<g;i++){const l=e();let r,a,s;if(l<.82){let m=t(e),n=t(e),f=t(e);const w=Math.hypot(m,n,f)||1;m/=w,n/=w,f/=w;const S=1+.075*Math.sin(6*n+4*m)*Math.cos(5*f+2*n)+.05*Math.sin(11*m+7*f),x=.93+e()*.09;r=m*.95*S*x,a=n*.6*S*x,s=f*.8*S*x,a<-.32&&(a=-.32-(Math.abs(a)-.32)*.35),a>.05&&Math.abs(r)<.1&&(r+=(r>=0?1:-1)*.09),r+=(r>=0?1:-1)*.03}else if(l<.95){let m=t(e),n=t(e),f=t(e);const w=Math.hypot(m,n,f)||1;m/=w,n/=w,f/=w;const S=1+.05*Math.sin(26*n),x=.9+e()*.12;r=m*.42*S*x,a=-.48+n*.24*S*x,s=-.5+f*.34*S*x}else{const m=e(),n=(1-m*.55)*.11,f=e()*Math.PI*2;r=Math.cos(f)*n,a=-.4-m*.45,s=-.16+m*.26+Math.sin(f)*n}c[i*3]=r*p+s*u,c[i*3+1]=a,c[i*3+2]=-r*u+s*p}y.push(c),b.push(new Float32Array(g))}return{positions:y,genes:b}}function Ee(){const g=getComputedStyle(document.documentElement),e=(y,b)=>{const c=g.getPropertyValue(y).trim();return new Re(c||b)};return{bio:e("--bio","#B6FF2E"),data:e("--data","#4FA8FF")}}const _e={high:5600,low:2400};function zt(g,{quality:e="high"}={}){const y=new st({canvas:g,alpha:!0,antialias:e==="high",powerPreference:"high-performance"});y.setClearColor(0,0);const b=new nt,c=new it(38,1,.1,120);c.position.set(0,0,4.4);const h=Ee(),p=new ie(1.15,e==="high"?152:88,e==="high"?104:60),u=new q({uniforms:{uTime:{value:0},uAmp:{value:.1},uProbeDir:{value:new j(0,0,1)},uProbeStrength:{value:0},uBio:{value:h.bio.clone()},uData:{value:h.data.clone()},uOpacity:{value:1}},vertexShader:vt,fragmentShader:gt,transparent:!0,depthWrite:!1,side:rt}),i=new pe(p,u);i.renderOrder=3,b.add(i);const l=_e[e]||_e.high,{positions:r,genes:a}=St(l),s=new De,m=new Float32Array(r[0]),n=new Float32Array(r[1]),f=new Float32Array(a[0]),w=new Float32Array(a[1]),S=new Float32Array(l);{const o=re(11);for(let v=0;v<l;v++)S[v]=o()}s.setAttribute("position",new k(r[0].slice(),3)),s.setAttribute("aPosA",new k(m,3)),s.setAttribute("aPosB",new k(n,3)),s.setAttribute("aGeneA",new k(f,1)),s.setAttribute("aGeneB",new k(w,1)),s.setAttribute("aSeed",new k(S,1)),s.boundingSphere=new Oe(new j(0,0,0),6);const x=new q({uniforms:{uTime:{value:0},uStageMix:{value:0},uSize:{value:e==="high"?11:9},uDrift:{value:1},uBio:{value:h.bio.clone()},uData:{value:h.data.clone()},uPal:Be(),uDataMix:{value:0},uStageF:{value:0},uWave:{value:0},uSwim:{value:0},uOpacity:{value:1}},vertexShader:yt,fragmentShader:xt,transparent:!0,depthWrite:!1,blending:de}),C=new Ge(s,x);C.renderOrder=2,b.add(C);const $=new ie(1,10,8),A=new q({uniforms:{uTime:{value:0},uBio:{value:h.bio.clone()},uData:{value:h.data.clone()},uOpacity:{value:1}},vertexShader:wt,fragmentShader:bt,transparent:!0,depthWrite:!1}),I=e==="high"?18:0,T=new lt($,A,Math.max(1,I));T.count=I;{const o=re(7),v=new ct,M=new ut,P=new j,R=new j;for(let D=0;D<I;D++){let W=t(o),O=t(o),z=t(o);const G=Math.hypot(W,O,z)||1,V=.55+o()*.38;R.set(W/G*V,O/G*V,z/G*V);const H=.05+o()*.09;P.set(H,H*(.7+o()*.6),H),v.compose(R,M,P),T.setMatrixAt(D,v)}}T.renderOrder=1,b.add(T);const J=`
  ...
  `,ee=new ie(30,32,24),B=new q({uniforms:{uTime:{value:0},uProg:{value:0},uOpacity:{value:.5},uBio:{value:h.bio.clone()},uData:{value:h.data.clone()}},vertexShader:`
      varying vec3 vDir;
      void main() {
        vDir = normalize(position);
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      }
    `,fragmentShader:J,transparent:!0,depthWrite:!1,side:mt}),ve=new pe(ee,B);ve.renderOrder=-2,b.add(ve);const Ce=`
    varying vec2 vUv;
    void main() {
  ...
  `,ge=new ft(1,1),te=new q({uniforms:{uTime:{value:0},uFuse:{value:0}},vertexShader:Ce,fragmentShader:Ie,transparent:!0,depthWrite:!1,depthTest:!1,blending:de}),oe=new pe(ge,te);oe.renderOrder=4,oe.visible=!1,b.add(oe);const Le=`
    attribute float aSeed;
    uniform float uTime;
    uniform float uProg;
    uniform float uSize;
  ...
  `,Q=e==="high"?7e3:3e3,L=new De;{const o=new Float32Array(Q*3),v=new Float32Array(Q),M=re(990749);for(let P=0;P<Q;P++){let R=t(M),D=t(M),W=t(M);const O=Math.hypot(R,D,W)||1,z=7+17*Math.pow(M(),.65);o[P*3]=R/O*z,o[P*3+1]=D/O*z*.8,o[P*3+2]=W/O*z,v[P]=M()}L.setAttribute("position",new k(o,3)),L.setAttribute("aSeed",new k(v,1)),L.boundingSphere=new Oe(new j(0,0,0),40)}const U=new q({uniforms:{uTime:{value:0},uProg:{value:0},uSize:{value:e==="high"?26:22},uOpacity:{value:1},uBio:{value:h.bio.clone()},uData:{value:h.data.clone()},uPal:Be()},vertexShader:Le,fragmentShader:Ne,transparent:!0,depthWrite:!1,blending:de}),ye=new Ge(L,U);ye.renderOrder=0,b.add(ye);const Ue=()=>{const o=Ee();for(const v of[u,x,A,B,U])v.uniforms.uBio.value.copy(o.bio),v.uniforms.uData.value.copy(o.data)},xe=new MutationObserver(Ue);xe.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]});let we=0,E=!1,le=e==="high"?11:9,be=.03,ce=[0,1];const _={x:0,y:0,strength:0},N={x:0,y:0,strength:0},ue=new pt,Se=new ht,Y=new j(0,0,1);let K=0,X=!1,ae=!1,se=0,F=0,me=null,ne=0,Z=0;const Ve=(o,v)=>{ce[0]===o&&ce[1]===v||(ce=[o,v],s.getAttribute("aPosA").array.set(r[o]),s.getAttribute("aPosB").array.set(r[v]),s.getAttribute("aGeneA").array.set(a[o]),s.getAttribute("aGeneB").array.set(a[v]),s.getAttribute("aPosA").needsUpdate=!0,s.getAttribute("aPosB").needsUpdate=!0,s.getAttribute("aGeneA").needsUpdate=!0,s.getAttribute("aGeneB").needsUpdate=!0)},He=()=>{const o=we,v=8,M=Math.min(v-.001,o*v),P=Math.min(v-1,Math.floor(M));Ve(P,P+1);const R=M-P;x.uniforms.uStageMix.value=d.smoothstep(R,.12,.88),x.uniforms.uStageF.value=P+d.smoothstep(R,.12,.88),x.uniforms.uSwim.value=d.smoothstep(o,.3,.36)*(1-d.smoothstep(o,.46,.52));const D=d.smoothstep(o,.455,.485)*(1-d.smoothstep(o,.555,.615));te.uniforms.uFuse.value=D,oe.visible=D>.01;const W=d.smoothstep(o,.02,.24),O=d.smoothstep(o,.8,.86)*(1-d.smoothstep(o,.92,.97)),z=d.smoothstep(o,.3,.36)*(1-d.smoothstep(o,.44,.5)),G=d.smoothstep(o,.44,.5)*(1-d.smoothstep(o,.54,.6)),V=d.smoothstep(o,.56,.62)*(1-d.smoothstep(o,.66,.72)),H=d.smoothstep(o,.68,.73)*(1-d.smoothstep(o,.79,.84)),fe=d.clamp(1/c.aspect-1,0,1.4)/1.4,je=d.smoothstep(o,.9,.97),$e=fe*(.4*d.smoothstep(o,.24,.4)+1*z+1.5*G+.9*V+1.2*H+1.8*O+1.6*je),Qe=1-d.smoothstep(o,.08,.28),Ye=E?1.4*Qe:0,Ke=E?4.8*z:0,Xe=E?5.5*G:0,ze=4.4-3.1*W+1.2*d.smoothstep(o,.3,.9)+1.7*O+1.4*z+3.4*G+2.6*V+1.9*H+$e+Ye+Ke+Xe,Ze=.55*d.smoothstep(o,.16,.3)+.55*d.smoothstep(o,.3,.46)+.4*d.smoothstep(o,.5,.64)+.4*d.smoothstep(o,.66,.78),Je=(Math.PI*2-1.9)*d.smoothstep(o,.79,.965),he=Ze+Je,et=E?-.34*G:0,Ae=-.52*(1-.6*fe)*d.smoothstep(o,.93,.985)*Math.cos(he)+et,Te=-.55*fe*d.smoothstep(o,.06,.2);if(c.position.x=Math.sin(he)*ze+Ae,c.position.z=Math.cos(he)*ze,c.position.y=Te+-.15*Math.sin(o*Math.PI)+.6*d.smoothstep(o,.3,.42)*(1-d.smoothstep(o,.52,.64)),c.lookAt(Ae,Te,0),E){const at=1-.45*d.smoothstep(o,.08,.3);c.rotateZ(d.degToRad(-11)*at)}u.uniforms.uOpacity.value=1-d.smoothstep(o,.08,.26),i.visible=u.uniforms.uOpacity.value>.01;const tt=1+W*2.2;i.scale.setScalar(tt),A.uniforms.uOpacity.value=u.uniforms.uOpacity.value,T.visible=i.visible,x.uniforms.uDataMix.value=d.smoothstep(o,.92,.99),x.uniforms.uDrift.value=1-.6*d.smoothstep(o,.93,.99),x.uniforms.uWave.value=d.smoothstep(o,.93,.99);const Fe=d.smoothstep(o,.8,.86)*(1-d.smoothstep(o,.9,.96));be=.03+.09*Fe,x.uniforms.uSize.value=le*(1+.6*d.smoothstep(o,.1,.5)+.35*Fe+.45*d.smoothstep(o,.93,1)+(E?.45*z+1*G:0));const ot=1-d.smoothstep(o,.05,.2);u.uniforms.uProbeStrength.value=N.strength*ot,B.uniforms.uProg.value=o,U.uniforms.uOpacity.value=1-.6*d.smoothstep(o,.44,.5)*(1-d.smoothstep(o,.68,.74)),B.uniforms.uOpacity.value=.5+.5*d.smoothstep(o,.15,.4),U.uniforms.uProg.value=o},qe=()=>{Se.set(_.x,_.y),ue.setFromCamera(Se,c);const o=ue.ray.origin,v=ue.ray.direction,M=Math.max(0,-o.dot(v));Y.copy(o).addScaledVector(v,M),Y.lengthSq()<1e-6&&Y.set(0,0,1),Y.normalize(),u.uniforms.uProbeDir.value.copy(Y)},Me=()=>{const o=performance.now()/1e3,v=Math.min(se?o-se:0,.1);se=o,F+=v,N.x+=(_.x-N.x)*.12,N.y+=(_.y-N.y)*.12,N.strength+=(_.strength-N.strength)*.08,u.uniforms.uAmp.value=.085+.028*Math.sin(F*.62),u.uniforms.uTime.value=F,x.uniforms.uTime.value=F,A.uniforms.uTime.value=F,i.rotation.y=F*.05,C.rotation.y+=v*be,B.uniforms.uTime.value=F,U.uniforms.uTime.value=F,te.uniforms.uTime.value=F,qe(),He(),y.render(b,c)},Pe=()=>{if(!(!X||ae)&&(K=requestAnimationFrame(Pe),Me(),me)){ne++;const o=performance.now();Z||(Z=o);const v=o-Z;v>=2e3&&(me(ne*1e3/v),ne=0,Z=o)}};return{setProbe(o,v,M){_.x=o,_.y=v,_.strength=M},setProgress(o){we=d.clamp(o,0,1)},resize(o,v,M){y.setPixelRatio(M),y.setSize(o,v,!1),E=o<=640&&v>o,c.fov=E?48:38,c.aspect=o/v,c.updateProjectionMatrix()},start(){X||ae||(X=!0,se=0,ne=0,Z=0,K=requestAnimationFrame(Pe))},stop(){X=!1,cancelAnimationFrame(K),K=0},renderOnce(){ae||Me()},onFps(o){me=o},setQuality(o){if(o==="low"){if(le=9,s.setDrawRange(0,Math.floor(l/2)),L.setDrawRange(0,Math.floor(Q/2)),i.geometry===p){const v=new ie(1.15,88,60);i.geometry=v,p.dispose()}}else le=e==="high"?11:9,s.setDrawRange(0,l),L.setDrawRange(0,Q)},dispose(){ae=!0,X=!1,cancelAnimationFrame(K),xe.disconnect(),ee.dispose(),B.dispose(),ge.dispose(),te.dispose(),L.dispose(),U.dispose(),i.geometry.dispose(),u.dispose(),s.dispose(),x.dispose(),$.dispose(),A.dispose(),T.dispose(),y.dispose();const o=y.getContext(),v=o&&o.getExtension("WEBGL_lose_context");v&&v.loseContext()}}}export{zt as createCellScene};
